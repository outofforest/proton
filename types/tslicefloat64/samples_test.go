...
func Test1(t *testing.T) {
	...
	l := msg1.Marshal(b)
	requireT.Equal(msg1.Size(), l)
	requireT.Equal([]byte{0x05, 0x8F, 0xC2, 0xF5, 0x28, 0x5C, 0x07, 0x60, 0xC0, 0x52, 0xB8, 0x1E, 0x85, 0xEB, 0xF1, 0x5F, 0x40,
...
func TestCustom(t *testing.T) {
	...
	msg1 := pkg1.MsgSliceFloat64Custom{
		Value: test.CustomSliceFloat64{-128.23, 127.78, -1.2, 0., 1.1},
	}
