...
func Test127Items(t *testing.T) {
	...
	msg1 := pkg1.MsgSlice{
		Value: []bool{true, false, true, false, true, false, true, false, true, false, true, false, true, false, true, false, true, false, true, false,
	...
	requireT.Equal([]byte{0x7F,
		...
		0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00,
		0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00,
		0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01}, b)
...
func Test128Items(t *testing.T) {
	...
	requireT.Equal([]byte{0x80, 0x01,
		...
		0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00,
		0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00,
		0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00}, b)
...
func TestCustom(t *testing.T) {
	...
	l := msg1.Marshal(b)
	requireT.Equal(msg1.Size(), l)
	requireT.Equal([]byte{0x09, 0x01, 0x0A, 0x1E, 0x64, 0x88, 0x27, 0xE7, 0xE3, 0x02, 0xF0, 0xAF, 0xC9, 0x8D, 0x10, 0xAB,
		0xF7, 0x96, 0x93, 0x84, 0xBC, 0x07, 0x9C, 0xDB, 0x86, 0xD4, 0xD2, 0xB2, 0x62}, b)
